...
class MPIIPoseDataset(CocoDataset):
    """
    ...
    FLIP_PAIRS = [[0, 5],   # Right ankle ↔ Left ankle
                  [1, 4],   # Right knee ↔ Left knee
                  [2, 3],   # Right hip ↔ Left hip
                  [10, 15], # Right wrist ↔ Left wrist
                  [11, 14], # Right elbow ↔ Left elbow
                  [12, 13]] # Right shoulder ↔ Left shoulder
    
    def __init__(self,
                 *args,
                 skip_invaild_pose=True,
                 **kwargs):
        super(MPIIPoseDataset, self).__init__(*args, **kwargs)
    ...
    def _parse_ann_info(self, img_info, ann_info):
        ...
        if gt_bboxes:
            ...
            gt_keypoints = np.zeros((0, 48), dtype=np.float32) # From 51
